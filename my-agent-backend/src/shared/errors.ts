...
export class SelfActionForbiddenError extends AppError { constructor(m = 'Cannot perform this action on yourself') { super(403, m, 'SELF_ACTION_FORBIDDEN'); } }
export class EnvAccessForbiddenError  extends AppError { constructor(m = 'No access to this environment')      { super(403, m, 'ENV_ACCESS_FORBIDDEN'); } }
